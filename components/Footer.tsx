...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-[#0C0C0C] border-t border-white/5 overflow-hidden w-full m-0 p-0">
      <style>{`
            ...
            <div className="lg:col-span-2">
              ...
              >
                <div className="mb-6 flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-linear-to-tr from-[#2E7BD1] to-[#FFB800] animate-pulse-slow shadow-[0_0_20px_rgba(46,123,209,0.5)]" />
                  <span className="text-xl font-bold tracking-tighter bg-clip-text text-transparent bg-linear-to-r from-white to-white/70">
                    Web3Nova
                  </span>
                </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex w-full md:w-auto">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-6 py-3 bg-linear-to-r from-[#2B6EFF] to-[#71A6FF] text-white font-semibold rounded-r-xl hover:shadow-lg hover:shadow-[#2B6EFF]/30 transition-all font-['Inter']"
              >
                Subscribe
              </motion.button>
            </div>
